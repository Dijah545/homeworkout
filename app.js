...
{id:"dbsquat",name:"Dumbbell Squat",area:"Lower Body",equipment:"Adjustable Dumbbells",img:null,sets:"3 sets × 10–12 reps",tips:["Hold dumbbells at your sides or shoulders.","Sit hips back and keep knees tracking over toes.","Drive through the whole foot to stand."]},
...
{id:"bandrow",name:"Resistance Band Row",area:"Upper Body",equipment:"Resistance Bands",img:null,sets:"3 sets × 12 reps",tips:["Anchor the band securely.","Pull elbows toward your ribs.","Squeeze shoulder blades without shrugging."]},
...
{id:"rdl",name:"Barbell Romanian Deadlift",area:"Lower Body",equipment:"Barbell",img:null,sets:"3 sets × 10 reps",tips:["Keep the bar close to the legs.","Push hips backward with soft knees.","Stop when hamstrings are loaded without rounding."]},
...
{id:"db-bent-over-row",name:"Dumbbell Bent-Over Row",area:"Upper Body",equipment:"Adjustable Dumbbells",img:null,sets:"3 sets \u00d7 8\u201312 reps",tips:["Hinge at the hips with a neutral spine.","Pull dumbbells toward your ribs.","Squeeze shoulder blades, then lower."],sourceGroup:"Adjustable Dumbbells"},
...
{id:"tube-u-11",name:"Resistance Band Tricep Extension",area:"Upper Body",equipment:"Resistance/Toning Tubes",img:null,sets:"3 sets \u00d7 10\u201315 reps",tips:["Anchor or position the tube securely before starting.","Keep steady tension through the working range.","Control both the effort and return phase."],sourceGroup:"Resistance/Toning Tubes"},
...
{id:"mat-u-5",name:"Plank Shoulder Tap",area:"Upper Body",equipment:"Exercise Mat",img:null,sets:"3 sets \u00d7 8\u201315 reps",tips:["Set your hands and body in a stable position.","Brace your core and keep your body aligned.","Move under control and adjust to a knee-supported variation if needed."],sourceGroup:"Exercise Mat \u2014 Upper Body"},
...
{id:"cool-0",name:"Hamstring Stretch",area:"Mobility & Recovery",equipment:"Exercise Mat",img:null,sets:"30\u201360 sec",tips:["Ease into the position until you feel a gentle stretch.","Breathe slowly and avoid bouncing.","Reduce the range if you feel joint pain or sharp discomfort."],sourceGroup:"Cool-Down / Stretching"},
...
{id:"cool-8",name:"Shoulder Stretch",area:"Mobility & Recovery",equipment:"Exercise Mat",img:null,sets:"30\u201360 sec",tips:["Ease into the position until you feel a gentle stretch.","Breathe slowly and avoid bouncing.","Reduce the range if you feel joint pain or sharp discomfort."],sourceGroup:"Cool-Down / Stretching"},
...
{id:"warm-standing-hip-circles",name:"Standing Hip Circles",area:"Mobility & Warm-Up",equipment:"Bodyweight / Exercise Mat",img:null,sets:"8–10 each side",tips:["Stand tall and hold a stable support if needed.","Lift one knee toward hip height and slowly open it outward in a controlled circle.","Return to the start and repeat before switching legs."],sourceGroup:"Pre-Workout Warm-Up"},
...
const defaults={activeWorkout:null,todayOrder:{},planSeed:0,
...
function saveCompletedWorkout(plan){
 clearActiveWorkout();
 if(workoutCompletedOn()){
   showToast("Today's workout is already marked complete");
   return;
 }
...
function todayReorderRow(ex,i,total,trackingDate=isoDate()){
 ...
 return `<div class="reorder-exercise-card" draggable="true" data-drag-id="${ex.id}" data-drag-index="${i}">
   ...
   <div class="reorder-controls">
     <button type="button" class="move-btn" data-move-index="${i}" data-move-dir="-1" ${i===0?"disabled":""}>↑ Move up</button>
     <button type="button" class="move-btn" data-move-index="${i}" data-move-dir="1" ${i===total-1?"disabled":""}>↓ Move down</button>
   </div>
   ${setTracker(ex,trackingDate)}
 </div>`;
}
 ...
 <section class="card today-workout-card">
  ...
  ${isRest(day)?
    ...
    `<div class="today-order-toolbar">
       ...
       <button type="button" class="secondary compact" id="resetTodayOrder">Reset order</button>
     </div>
...
function renderSettings(){
 ...
 <section class="card"><button class="secondary" id="export" style="width:100%">Export History</button><div style="height:8px"></div><button class="secondary" id="reset" style="width:100%;color:var(--danger)">Reset App Data</button></section>`;
...
function completeWorkout(plan,totalRest,restSessions){
 ...
 save(); closeModal(); showToast("Workout and rest time saved"); route("history");
}
