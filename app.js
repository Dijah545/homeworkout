...
const defaults={bodyMetrics:[],bodyMetricUnit:"lb",measurementUnit:"in",swapChoices:{},exercisePerformance:{},exerciseProfiles:{},workoutRatings:{},activeWorkout:null,todayOrder:{},planSeed:0,
 finisherMode:"treadmill",finisherExerciseId:"",finisherMinutes:10,autoFinisherByDay:{},
...
function generatedFinisherSelection(day=new Date().getDay()){
 ...
 const availableModes=["cardio","core"].filter(mode=>finisherChoices(mode).length);
